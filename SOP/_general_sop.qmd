...
This semester I am self-learning etale cohomology and Artin-Verdier duality using Mazur's notes, Thomas Zink's appendix and Roger W. Carter's appendix. This topic exposed me a lot of advanced mathematics, including Class Field Theory, spectral sequence, derived functor, Grothendieck topology. Probably, my bachelor thesis will be about this topic. Briefly speaking, Artin-Verdier duality states that the ring of integers in a number field of finite degree over $\mathbb{Q}$ behaves like a $3$-manifold.
