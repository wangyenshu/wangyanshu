  ...
  html:
    ...
    include-in-header:
      ...
      - text: |
          ...
          <script>
            class MathJaxHandler extends Paged.Handler {
              constructor(chunker, polisher, caller) {
                super(chunker, polisher, caller);
              }
          
              afterPreview(pages) {
                // This triggers MathJax 3 to re-render all math on the pages
                if (window.MathJax && window.MathJax.typesetPromise) {
                  window.MathJax.typesetPromise().then(() => {
                    console.log("MathJax re-rendered after paging!");
                  });
                }
              }
            }
            ...
            Paged.registerHandlers(MathJaxHandler);
          </script>
    resources: 
      - Course_Table.pdf
      - Dessin_Equation_JMM_Poster.pdf
      - Dessins_d_enfants_and_complete_regular_maps_presentation.pdf
      - rank_proof.jpg
---
<div style="font-size: 1.5em; font-weight: bold; text-align: center;">Yanshu Wang</div><br>

Cell Phone Number: +1<div id="hide" hidden> 7386727</div>2679021268 <br>
Email: wangyenshu AT outlook DOT com <br>
